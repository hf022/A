...
RUTA = f"http://pad19.com:3030/pedidos/10?token={TOKEN}"
productos = RUTA
...
while (True):
    id = int(input("ingresar codigo de producto: "))
    print ("para finalizar pulse f")
 
  

    def enviar_pedido(params):
        solicitud = requests.post(RUTA, json=params)
